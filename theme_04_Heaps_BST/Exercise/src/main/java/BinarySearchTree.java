    ...
    public E floor(E element) {
        ...
        while (current != null) {
            if (isGreater(element, current)) {
                ...
                if (current.getLeft() != null && nearestSmaller != null) {
                    nearestSmaller = isGreater(left.value, nearestSmaller) ? left : nearestSmaller;
        ...
        while (current != null) {
            if (isLess(element, current)) {
                ...
                if (right != null && nearestBigger != null) {
                    nearestBigger = isLess(right.value, nearestBigger) ? right : nearestBigger;
